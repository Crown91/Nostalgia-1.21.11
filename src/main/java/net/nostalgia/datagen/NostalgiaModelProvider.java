...
public class NostalgiaModelProvider implements DataProvider {
    ...
    public NostalgiaModelProvider(FabricDataOutput output) {
        this.output = output;
    }
        ...
        try {
            for (java.lang.reflect.Field field : AlphaItems.class.getDeclaredFields()) {
                if (Item.class.isAssignableFrom(field.getType())) {
                    ...
                    futures.add(DataProvider.saveStable(writer, JsonParser.parseString(modelJson), output.getOutputFolder().resolve("assets/nostalgia/models/item/" + name + ".json")));
                    String itemDefJson = "{\n  \"model\": {\n    \"type\": \"minecraft:model\",\n    \"model\": \"nostalgia:item/" + name + "\"\n  }\n}";
                    futures.add(DataProvider.saveStable(writer, JsonParser.parseString(itemDefJson), output.getOutputFolder().resolve("assets/nostalgia/items/" + name + ".json")));
                }
            }
            for (java.lang.reflect.Field field : AlphaBlocks.class.getDeclaredFields()) {
                if (Block.class.isAssignableFrom(field.getType())) {
                    ...
                    boolean is2DIcon = name.equals("alpha_lever") || name.equals("alpha_torch") || name.equals("alpha_redstone_torch") || name.equals("alpha_yellow_flower") || name.equals("alpha_red_flower") || name.equals("alpha_brown_mushroom") || name.equals("alpha_red_mushroom") || name.equals("alpha_cobweb") || name.equals("alpha_sapling") || name.equals("alpha_ladder");
                    String modelJson;
                    if (name.equals("alpha_furnace")) modelJson = "{\n  \"parent\": \"minecraft:block/furnace\"\n}";
                    else if (is2DIcon) { String tex = name.equals("alpha_redstone_torch") ? "alpha_redstone_torch_on" : name; modelJson = "{\n  \"parent\": \"minecraft:item/generated\",\n  \"textures\": {\n    \"layer0\": \"nostalgia:block/" + tex + "\"\n  }\n}"; }
                    else if (name.equals("alpha_wooden_door") || name.equals("alpha_iron_door") || name.equals("alpha_sugar_cane") || name.equals("alpha_wheat")) modelJson = "{\n  \"parent\": \"minecraft:item/generated\",\n  \"textures\": {\n    \"layer0\": \"nostalgia:item/" + name + "\"\n  }\n}";
    ...
    @Override
    public String getName() { return "Nostalgia Custom Models"; }
}
