...
public class GlassBreakRenderer {
    ...
    public static void start(BlockPos pos) {
        active = true;
        startMs = net.nostalgia.client.events.echo.RitualVisualManager.getVisualTime();
        anchor = pos;
    }
    ...
    public static float getTimeSeconds() {
        ...
        long elapsed = net.nostalgia.client.events.echo.RitualVisualManager.getVisualTime() - startMs;
    ...
    public static void render(DeltaTracker tracker) {
        ...
        // Camera matrix access is centralised in UboShaderUtil so the 1.21.11
        // replacement for the removed Camera matrix getters lives in one place.
