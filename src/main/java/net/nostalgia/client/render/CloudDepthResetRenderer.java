...
public class CloudDepthResetRenderer {
    ...
    public static boolean shouldRender() {
        ...
        return net.nostalgia.client.events.core.ClientRitualEventRegistry.activeSkyPortal() != null
            || net.nostalgia.client.events.core.ClientRitualEventRegistry.activeTransition() != null;
    }
    ...
    public static void render(RenderTarget target, DeltaTracker tracker) {
        ...
        org.joml.Matrix4f invViewProj = UboShaderUtil.getInverseViewProjMatrix(camera, PortalSkyRenderer.capturedProjectionMatrix);
