...
public final class PlasmaWireRenderer {
  public static void drawWireBase(GuiGraphics graphics, PlasmaWireRenderer.WirePath path, int x, int y) {
  ...
  public static void drawWirePathRange(GuiGraphics graphics, PlasmaWireRenderer.WirePath path, int x, int y, int d1, int d2, int width, int color) {
    if (d1 < d2) {
      int currentDist = 0;
  ...
  public static void drawCableLightning(GuiGraphics graphics, PlasmaWireRenderer.WirePath path, int x, int y, float time, int color) {
