...
public class NostalgiaNetworking {
    ...
    public static void register() {
        ...
        PayloadTypeRegistry.playS2C().register(S2CSyncAlphaDeltasPayload.TYPE, S2CSyncAlphaDeltasPayload.CODEC);
        PayloadTypeRegistry.playS2C().register(S2CStartTransitionVisualsPayload.TYPE, S2CStartTransitionVisualsPayload.CODEC);
        PayloadTypeRegistry.playS2C().register(S2CEndTransitionVisualsPayload.TYPE, S2CEndTransitionVisualsPayload.CODEC);
        PayloadTypeRegistry.playS2C().register(S2CSyncParticipantsPayload.TYPE, S2CSyncParticipantsPayload.CODEC);
        PayloadTypeRegistry.playS2C().register(S2CRitualPhasePayload.TYPE, S2CRitualPhasePayload.CODEC);
        PayloadTypeRegistry.playS2C().register(S2CBystanderVisualsPayload.TYPE, S2CBystanderVisualsPayload.CODEC);
        PayloadTypeRegistry.playS2C().register(S2CSkyPortalPayload.TYPE, S2CSkyPortalPayload.CODEC);
        PayloadTypeRegistry.playS2C().register(S2CGlassBreakPayload.TYPE, S2CGlassBreakPayload.CODEC);
        PayloadTypeRegistry.playS2C().register(S2CTimestopZoneStartPayload.TYPE, S2CTimestopZoneStartPayload.CODEC);
        PayloadTypeRegistry.playS2C().register(S2CTimestopZoneEndPayload.TYPE, S2CTimestopZoneEndPayload.CODEC);
        PayloadTypeRegistry.playS2C().register(S2CZoneCollapsePayload.ID, S2CZoneCollapsePayload.CODEC);
        PayloadTypeRegistry.playS2C().register(S2CSetTerminalErrorPayload.TYPE, S2CSetTerminalErrorPayload.CODEC);
        PayloadTypeRegistry.playS2C().register(S2CDimensionSectionsPayload.TYPE, S2CDimensionSectionsPayload.CODEC);
        PayloadTypeRegistry.playS2C().register(S2CHologramReadyPayload.TYPE, S2CHologramReadyPayload.CODEC);
        PayloadTypeRegistry.playS2C().register(S2CDebugOwerPayload.TYPE, S2CDebugOwerPayload.CODEC);
        PayloadTypeRegistry.playS2C().register(S2CSkyPortalCancelPayload.TYPE, S2CSkyPortalCancelPayload.STREAM_CODEC);
        PayloadTypeRegistry.playS2C().register(S2CSkyPortalLandingPayload.TYPE, S2CSkyPortalLandingPayload.CODEC);
        PayloadTypeRegistry.playC2S().register(C2STravelRequestPayload.TYPE, C2STravelRequestPayload.CODEC);
        PayloadTypeRegistry.playC2S().register(C2SCacheReadyPayload.TYPE, C2SCacheReadyPayload.CODEC);
        PayloadTypeRegistry.playC2S().register(C2SBoatCrashPayload.TYPE, C2SBoatCrashPayload.CODEC);
        PayloadTypeRegistry.playC2S().register(C2SReportHologramSurfacePayload.TYPE, C2SReportHologramSurfacePayload.CODEC);
        PayloadTypeRegistry.playC2S().register(C2SRequestPortalDeltasPayload.TYPE, C2SRequestPortalDeltasPayload.CODEC);
        PayloadTypeRegistry.playC2S().register(C2SProgramAmethystPayload.TYPE, C2SProgramAmethystPayload.CODEC);
        PayloadTypeRegistry.playC2S().register(C2SSkyPortalLandingRequestPayload.TYPE, C2SSkyPortalLandingRequestPayload.CODEC);
